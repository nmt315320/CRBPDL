...
def CKSNAP_NCP_Encoding(sampleSeq3DArr):
    ...
    for sequence in sampleSeq3DArr:
        ...
        for g in range(gap + 1):
            ...
            for pair in aaPairs:
                ...
                probMatr[sampleNo][AANo][6] = myDict[pair] / float(sum2)
    ...
    for sequence in sampleSeq3DArr:
        ...
        for g in range(gap + 1):
            ...
            for pair in aaPairs:
                ...
                probMatr[sampleNo][AANo][16] = myDict[pair] / float(sum1)
    ...
    for sequence in sampleSeq3DArr:
        ...
        for j in range(len(sequenceStr) - 2):
            ...
            if re.search('-', pair):
                ...
                probMatr[sampleNo][AANo][24] = po_number/float(p_num) - ne_number/float(n_num)
    ...
    for sequence in sampleSeq3DArr:
        ...
        for j in range(len(sequenceStr)):
            ...
            if j < len(sequenceStr) and j + window <= len(sequenceStr):
                ...
                for key in count:
                    count[key] = count[key] / float(len(sequenceStr[j:j + window]))
